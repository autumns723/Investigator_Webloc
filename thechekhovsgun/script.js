...
$(document).ready(function() {
	/* Setup Variables */
	var clue1, clue2, clue3, clue4, clue5, clue6, clue7, clue8, clue9, clue10, suspect1, suspect2, suspect3, suspect4, act2checkpoint, act3checkpoint = false;
	...
	function act1() {
		...
		$("#act1").fadeIn(700,function() {
			conversation(
				...
				"Investigator", "That explains Bobbycat's absence. By the way, Dogtective, why do you say <em>apparent</em> suicide?", '',
				"Dogtective", "The murder weapon — a gun, by the way, Chekhov's brand, revolver, 22LR — belongs to him, and ballistics match the bullet found in the left side of his head. But there's no suicide note, and, well — I'll leave it to your famous investigative skills to find out the rest for yourself.", 'clue1',
